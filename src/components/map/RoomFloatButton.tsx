      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-0 bg-white w-full flex flex-col p-20 pb-0 gap-12 rounded-t-xl border border-gray-300"
          >
            ...
            <ul className="gap-6 flex flex-col max-h-186 overflow-y-auto pb-20 custom-scrollbar">
              {roomList?.map((item) => (
                <li
                  ...
                  key={item.id}
                  className="flex gap-6 items-center px-8 py-11 rounded-lg border-gray-300 border cursor-pointer hover:bg-gray-100"
                >
                  <div
