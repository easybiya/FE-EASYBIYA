      ...
      <div>
        {type === 'meatball' ? (
          ...
          <button
            type="button"
            onClick={toggleDropdown}
            className="flex justify-center items-center pl-4 pr-2 py-2 text-sm font-medium rounded-md border border-gray-300 text-gray-800 bg-white hover:bg-gray-100 focus:outline-none"
          >
          ...
          <div className="p-1">
            {options.map((option) => (
              <button
                ...
                className="w-full p-2 rounded-[4px] text-sm text-left text-gray-700 hover:bg-gray-100"
              >
                {option}
              </button>
            ))}
